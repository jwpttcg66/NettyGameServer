...
public class LevelInfo {
    ...
    private int        ID;        // 编号
    private String     levelName; // 关卡名
    private String     className; // 类型
    private String     sceneName; // 场景
    private String     levelPath; // 关卡路径名
    private String     atkCampPos; // 攻击阵营位置
    private String     defCampPos; // 防守阵营位置
    private String     atkCameraOffset; // 攻击方相机偏移
    private String     atkCameraRotation; // 攻击方相机旋转
    private String     defCameraOffset; // 防守方相机偏移
    private String     defCameraRotation; // 防守方相机旋转
    private int        minimap;   // 小地图编号
    private int        duration;  // 持续时间
    private String     atkEntities; // 攻击方角色
    private String     defEntities; // 防守方角色
    private int        maxLvl;    // 最大等级
    private float      DeadPosY;  // 死亡坐标Y阈值
    private int        rebornType; // 复活方式
    private String     atkRebornPoints; // 攻击方复活点
    private String     defRebornPoints; // 防守方复活点
    private float      rebornCD;  // 复活cd
    private float      rebornCDDelta; // 复活cd增量
