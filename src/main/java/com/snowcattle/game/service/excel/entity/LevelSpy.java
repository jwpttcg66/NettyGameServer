...
public class LevelSpy {
    ...
    private String     kingSkills; // 大鬼技能
    private String     spySkills; // 小鬼技能
    private String     civilianSkills; // 平民技能
    private int        maxPlayer; // 房间最大人数
    private float      waitingTime; // 创建房间时间
    private float      prepareTime; // 准备时间
    private int        bigGhostRebornCounts; // 大鬼复活次数
    private int        smallGhostRebornCounts; // 小鬼复活次数
    private int        farmerCounts; // 农民复活次数
    private float      kingScale; // 大鬼缩放
