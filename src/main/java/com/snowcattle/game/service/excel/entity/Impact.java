...
public class Impact {
    ...
    private String     className; // 效果类
    private int        damageType; // 伤害类型
    private float      beginTime; // 前摇时间
    private float      castTime;  // 持续时间
    private float      endTime;   // 后摇时间
    private float      bulletSpeed; // 弹道飞行速度
    private int        maxTargets; // 最大伤害人数
    private String     npcs;      // 召唤NPC
    private String     buffAdd;   // 增加buff
    private String     buffDel;   // 移除buff
    private String     controlDel; // 移除控制类
    private int        hpType;    // hp类型
    private int        hpBasic;   // hp基础值
    private float      hpFactor;  // hp系数
    private int        mpType;    // mp类型
    private int        mpBasic;   // mp基础值
    private float      mpFactor;  // mp系数
    private int        chType;    // 效果范围类型
    private float      chRadius;  // 区域半径
    private float      chAngle;   // 区域角度
    private float      chWidth;   // 区域宽
    private float      chHeight;  // 区域高
    private String     relations; // 作用关系
    private String     targetClasses; // 作用单位类型
    private String     beganAction; // 起手动作
    private String     beganEffect; // 起手特效
    private String     castAction; // 出手动作
    private String     castEffect; // 出手特效
    private String     bulletEffect; // 弹道飞行特效
    private String     endedAction; // 收手动作
    private String     endedEffect; // 收手特效
    private String     hitAction; // 命中动作
    private String     hitEffect; // 命中特效
    private String     emitter;   // 切换弹幕
    private boolean    transport; // 是否传送
