...
public class LevelVolleyball {
    ...
    private String     attackRect; // 攻击方区域
    private String     defenceRect; // 防守方区域
    private float      minHeight; // 最小高度
    private float      maxHeight; // 最大高度
    private float      shadowTime; // 显示阴影时间
    private int        scoreBounce; // 反弹得分
    private int        scoreKill; // 击杀得分
    private int        scoreLost; // 丢球得分
    private String     rects;     // 区域
