 ...
 */
@Service
public class GameZookeeperRpcServiceDiscovery extends ZookeeperRpcServiceDiscovery{
    public GameZookeeperRpcServiceDiscovery() {
        super(ZooKeeperNodeBoEnum.GAME);
    }
}
