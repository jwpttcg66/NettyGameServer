...
public class Skill {
    ...
    private String     className; // 技能类
    private int        kind;      // 类型
    private int        playType;  // 释放类型
    private float      distance;  // 施法距离
    private int        consumeHp; // hp消耗
    private int        consumeMp; // mp消耗
    private int        consumeCash; // 金钱消耗
    private String     consumeItem; // 道具消耗
    private float      cd;        // cd
    private String     impacts;   // 效果
    private String     selfHatred; // 自身仇恨公式
    private String     targetHatred; // 目标仇恨公式
    private float      attack2mp; // 攻击回能
    private float      damage2mp; // 受击回能
    private String     icon;      // 图标
    private int        indType;   // 指示器类型
    private float      indRadius; // 指示器半径
    private float      indAngle;  // 指示器角度
    private int        emitterID; // 发射器ID
    private float      emitterDuration; // 发射器持续时间
    private boolean    autoAim;   // 是否自动瞄准
    private int        knack;     // 被动技编号
    private float      spellTime; // 读条时间
    private String     spellAction; // 读条动作
    private String     spellEffect; // 读条特效
